...
from layers.layers import GraphConvolution, Linear, GraphSAGE, GraphCurvConvolution
...
class SAGEDecoder(Decoder):
    ...
    def __init__(self, c, args):
        ...
        act = lambda x: x
        self.cls = GraphSAGE(args.dim, args.n_classes, args.dropout, act, args.bias)
        self.decode_adj = True


class CurvDecoder(Decoder):
    """
    Graph Convolution Decoder.
    """

    def __init__(self, c, args):
        super(CurvDecoder, self).__init__(c)
        act = lambda x: x
        self.cls = GraphCurvConvolution(args.dim, args.n_classes, args.dropout, act, args.bias)
        self.decode_adj = True
